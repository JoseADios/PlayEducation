            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-header pb-0 mb-2">
                        <div class="row mb-1">
                            <div class="col-8 d-flex align-items-center">
                                <h6 class="mb-0">Historial Promedio de calificaciones</h6>
                            </div>
                            <div class="col-4 d-flex justify-content-end align-items-center">
                                <select class="form-control" name="grupo" id="grupo">
                                    @foreach ($grupos as $grupo)
                                        <option wire:click="obtenerCalsByMes(2)" value="{{$grupo->id}}">{{$grupo->nombre}}</option>
                                    @endforeach
                                </select>
                                <button wire:click="pruebaToTrue()">Activar</button>
                                @if (!$prueba)
                                    <button wire:click="pruebaToFalse()">Desactivar</button>
                                @endif
...
>>>>>>> b8cf367e812b436090e3d1698c0f3a9d31b13d63
...
=======
    ...
    // Extraer los meses y las calificaciones
    var meses = data2.map(function(item) {
        return mesesAbreviados[parseInt(item.mes) - 1];
    });

    var calificaciones = data2.map(function(item) {
        return item.avg_calificacion;
    });
